...
#### 曾用Openwrt旁路由科学上网，国内带宽相对直连带宽打了个2折，且使用多有不便。其实家庭网络简单好用即可，改为仅一台华硕硬路由满足家庭上网需求，安装了Merlinclash科学上网，而在Merlinclash中不易配置分流规则，沿用了Openclash的配置文件，效果接近无感！至于广告拦截，可以在硬路由或终端上安装相关插件。
